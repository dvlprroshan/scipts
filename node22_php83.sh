...
# Ubuntu 24.04 Development Environment Setup Script (PHP 8.3)
...
# Start installation
echo -e "${GREEN}Starting Ubuntu 24.04 Development Setup (PHP 8.3)...${NC}" >&3
echo -e "${YELLOW}Logs are being written to: $LOG_FILE${NC}" >&3
echo >&3

log "Starting installation script with PHP 8.3"
...
show_progress "Installing PHP 8.3 and extensions..."
